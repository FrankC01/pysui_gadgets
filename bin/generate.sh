...
usage_help() {
    ...
    echo -e "\tall - Command builds pysui_gadgets documentation, pysui distribution package and publishes to Production PyPi"
    echo -e "\tdoc - Command only builds pysui_gadgets documentation and exits"
    echo -e "\tbuild - Command only builds pysui_gadgets distribution package and exits"
